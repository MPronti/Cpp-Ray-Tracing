...
int main() {
    ...
    spheres.push_back(Sphere(Vec3(0, 0, -5), 1, Vec3(1, 0, 0))); // Red sphere
    spheres.push_back(Sphere(Vec3(2, 0, -6), 1, Vec3(0, 1, 0))); // Green sphere
    spheres.push_back(Sphere(Vec3(-2, 0, -4), 1, Vec3(0, 0, 1))); // Blue sphere
